...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Technology":
			resolverName, err := entityResolverNameForTechnology(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Technology": %w`, err)
			}
			switch resolverName {
			...
			case "findTechnologyByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findTechnologyByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindTechnologyByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Technology": %w`, err)
				}
...
func entityResolverNameForTechnology(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findTechnologyByID", nil
	}
	return "", fmt.Errorf("%w for Technology", ErrTypeNotFound)
}
